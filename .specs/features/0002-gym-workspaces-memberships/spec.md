...
| -------------- | --------------------------------- | ------ | --------- |
| GWM-01         | Establish Global Identity         | Design | In Design |
| GWM-02         | Establish Global Identity         | Design | In Design |
...
| GWM-06         | Provision Gym Workspaces          | Design | In Design |
| GWM-07         | Provision Gym Workspaces          | Design | In Design |
| GWM-08         | Provision Gym Workspaces          | Design | In Design |
| GWM-09         | Resolve Active Gym Context        | Design | In Design |
...
| GWM-13         | Resolve Active Gym Context        | Design | In Design |
| GWM-14         | Resolve Active Gym Context        | Design | In Design |
| GWM-15         | Gym-Owned Records and Audit Store | Design | In Design |
| GWM-16         | Gym-Owned Records and Audit Store | Design | In Design |
| GWM-17         | Gym-Owned Records and Audit Store | Design | In Design |
| GWM-18         | Gym-Owned Records and Audit Store | Design | In Design |
| GWM-19         | Gym-Owned Records and Audit Store | Design | In Design |
| GWM-20         | Gym-Owned Records and Audit Store | Design | In Design |
| GWM-21         | Edge Cases                        | Design | In Design |
